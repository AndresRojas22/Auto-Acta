...
<body>
    ...
    if(isset($_POST['Nombre']))
    {
        ...
        $InstruccionSQL = ("SELECT * from ActDef where Nombre = '$Nombre' and ApellidoP = '$ApellidoP' and ApellidoM ='$ApellidoM' and Sexo = '$Sexo' and FechaNac = '$FechaNac' and EstadoReg = '$Estado' and FechaDef = '$FechaDef';");
        $Resultado = mysqli_query($conn,$InstruccionSQL);
          $rs = mysqli_num_rows($Resultado);

          if($rs==1)
          {
            echo'<form action ="BusquedaCorrectaDef.php" method = "post">

...
<body>
   ...
   if($conn -> connect_error)
   {
    ...
    if(isset($_POST['Nombre']))
    {
        ...
        $instruccion_SQL = "DELETE FROM ActDef WHERE Nombre = '$Nombre' and ApellidoP = '$ApellidoP' and ApellidoM ='$ApellidoM' and Sexo = '$Sexo' and FechaNac = '$FechaNac' and EstadoReg = '$Estado' and Fechadef = '$FechaDef'";

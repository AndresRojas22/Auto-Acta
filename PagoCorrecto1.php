        ...
        <nav>
          ...
          <section class="Container">
              <div class="Center-align">
                ...
                <h3>Pago correcto!<br> De click en el boton para generar el PDF el pago</h3>
                <form action="PagoCorrecto.php" method="post">
                    <input class="btn big" name="Buscar" type="submit" value="Generar PDF">
                </form>
              </div>
          </section>

...
$dbhost="localhost";
  ...
  $pdf->Ln();
  $pdf->Cell(195,10,utf8_decode('Acta de defunción'),0,0,'C');
  $pdf->Ln();
  $pdf->Ln();
  ...
  $pdf->Ln(15);
  $pdf->SetFont('Arial','B',20);
  $pdf->Cell(180,10,utf8_decode($_SESSION["registro"]["FechaDef"]),0,0,'C');
  $pdf->Ln(10);
  $pdf->SetFont('Arial','U',12);
  $pdf->Cell(180,10,utf8_decode('Fecha de defunción'),0,0,'C');
